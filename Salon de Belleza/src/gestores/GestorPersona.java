...
public class GestorPersona {
    ...
    public boolean verificarSiExiste (GestorPersona almacenPersonas,String dni) throws DNInoEncontradoException {
        for (Persona p : almacenPersonas.getAlmacenPersonas()) {
            if (p.getDni().equals(dni)) {
                return true;
            }
        }
